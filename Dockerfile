...
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name clementime clementime
...
# Install JavaScript dependencies and build React frontend
