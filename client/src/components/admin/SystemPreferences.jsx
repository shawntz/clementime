...
export default function SystemPreferences() {
  ...
  const [config, setConfig] = useState({
    ...
    slack_student_message_template: '📝 Oral Exam Session for {{student_name}}\n\n📊 Exam Number: {{exam_number}}\n📅 Date: {{date}}\n⏰ Time: {{time}}\n📍 Location: {{location}}\n👤 Facilitator: {{ta_name}}\n\n📋 Course: {{course}} | 🎓 Term: {{term}}',
    ...
    ignored_section_codes: '01'  // Comma-separated list of section codes to ignore (e.g., "01" or "01,00")
  });
