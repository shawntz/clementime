  ...
  const features = [
    {
      ...
      description:
        'Automatically generate optimized exam schedules that respect student constraints and balance TA workloads.',
      icon: '📅',
    ...
    },
    {
      ...
      description:
        'Import rosters directly from Canvas. Match students with Slack for seamless notifications.',
      icon: '🎓',
    ...
    },
    {
      ...
      description:
        'Automatically organize and upload exam recordings to Google Drive with smart folder structures.',
      icon: '🎙️',
    ...
    },
    {
      ...
      description:
        'Send automated Slack notifications to students with their exam schedules and details.',
      icon: '🔔',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-500 via-orange-500 to-secondary-500 overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute top-0 -right-4 w-72 h-72 bg-yellow-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="flex items-center space-x-3 animate-slide-down">
              ...
              <h1 className="text-2xl font-bold text-white tracking-tight">Clementime</h1>
            </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-32 text-center">
        <div className="animate-slide-up">
          ...
          <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto mb-12 leading-relaxed">
            The complete solution for managing oral exams in university courses. Smart scheduling,
            automatic notifications, and seamless recording management.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-slide-up">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Built for instructors and TAs who want to spend less time on logistics and more time
              teaching.
            </p>
          </div>
            ...
            {features.map((feature, idx) => (
              <div
                ...
                className={`group relative p-8 rounded-3xl transition-all duration-500 cursor-pointer ${
                  activeFeature === idx ? 'scale-105 shadow-2xl' : 'hover:scale-105 shadow-lg'
                }`}
                style={{
                  background:
                    activeFeature === idx
              ...
              >
                <div
                  className={`text-6xl mb-6 transform group-hover:scale-110 group-hover:rotate-12 transition-transform duration-500 ${activeFeature === idx ? 'animate-bounce-slow' : ''}`}
                >
                  {feature.icon}
                </div>
                <h3
      ...
      <div className="relative bg-gradient-to-br from-orange-500 to-red-600 py-16 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="backdrop-blur-2xl bg-white/10 p-8 rounded-3xl border-2 border-white/30 shadow-2xl hover:scale-105 transition-transform duration-300">
            ...
            <p className="text-white/90 mt-4 text-lg">Managing oral exams for 200+ students</p>
          </div>
        </div>
      </div>
            ...
            {[
              {
                step: '1',
                title: 'Fork & Deploy',
                desc: 'Click "Use this template" on GitHub and deploy to Render.com in 5 minutes.',
                color: 'from-orange-400 to-pink-500',
              },
              {
                step: '2',
                title: 'Upload Roster',
                desc: 'Import your Canvas roster CSV and match students with Slack.',
                color: 'from-purple-400 to-indigo-500',
              },
              {
                step: '3',
                title: 'Generate Schedule',
                desc: 'Let Clementime optimize exam times based on student constraints.',
                color: 'from-blue-400 to-cyan-500',
              },
              {
                step: '4',
                title: 'Send Notifications',
                desc: 'Automatically notify students via Slack with their exam details.',
                color: 'from-green-400 to-teal-500',
              },
            ].map((item, idx) => (
              <div key={idx} className="text-center group">
                <div
                  className={`w-20 h-20 mx-auto mb-6 rounded-full bg-gradient-to-br ${item.color} flex items-center justify-center text-3xl font-extrabold text-white shadow-2xl transform group-hover:scale-125 group-hover:rotate-12 transition-all duration-500 animate-float`}
            ...
            <div className="pt-4">
              ...
              <div className="flex justify-center items-center gap-4 flex-wrap">
                ...
                <div className="flex items-center gap-2 bg-gray-800 px-4 py-2 rounded-lg hover:bg-gray-700 transition-colors">
                  ...
                  >
                    <path
                      d="M12 6.036L8.206 9.828L7.5 9.122L12 4.622L16.5 9.122L15.794 9.828L12 6.036Z"
                      fill="#38BDF8"
                    />
                    <path
                      d="M8.206 12.172L12 15.964L15.794 12.172L16.5 12.878L12 17.378L7.5 12.878L8.206 12.172Z"
                      fill="#38BDF8"
                    />
                    <path
                      d="M6.25 11L12 5.25L17.75 11L12 16.75L6.25 11Z"
                      stroke="#38BDF8"
                      strokeWidth="1.5"
                      fill="none"
                    />
