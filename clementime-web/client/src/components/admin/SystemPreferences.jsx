...
const DEFAULT_SLACK_TEMPLATES = {
  student:
    '📝 Oral Exam Session for {{student_name}}\n\n📊 Exam Number: {{exam_number}}\n📅 Date: {{date}}\n⏰ Time: {{time}}\n📍 Location: {{location}}\n👤 Facilitator: {{ta_name}}\n\n📋 Course: {{course}} | 🎓 Term: {{term}}',
...
export default function SystemPreferences() {
  ...
  const resetTemplate = (templateType) => {
    if (
      !confirm(
        `Reset ${templateType === 'student' ? 'Student Notification' : 'TA/Admin Schedule'} message to default template?`
      )
    ) {
      return;
    }
    ...
    const field =
      templateType === 'student' ? 'slack_student_message_template' : 'slack_ta_message_template';
  ...
  return (
    <div className="card">
      <h3 style={{ color: 'var(--primary)', marginBottom: '1rem' }}>Preferences</h3>
      ...
      >
        <button
          ...
          style={{
            ...
            border: 'none',
            borderBottom:
              activeTab === 'exam' ? '2px solid var(--primary)' : '2px solid transparent',
        ...
        <button
          ...
          style={{
            ...
            border: 'none',
            borderBottom:
              activeTab === 'integrations' ? '2px solid var(--primary)' : '2px solid transparent',
        ...
        <button
          ...
          style={{
            ...
            border: 'none',
            borderBottom:
              activeTab === 'slack-messages' ? '2px solid var(--primary)' : '2px solid transparent',
      ...
      <form onSubmit={handleSubmit}>
        {activeTab === 'exam' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div>
              ...
              >
                Specify the exact date for each oral exam session (odd and even sections have
                different dates)
              </small>
              {Array.from({ length: config.total_exams }, (_, i) => i + 1).map((examNum) => (
                ...
                >
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                    <div>
                      <label
                        htmlFor={`exam_date_${examNum}_odd`}
                        style={{
                          display: 'block',
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleChange('exam_dates', {
                            ...config.exam_dates,
                            [`${examNum}_odd`]: e.target.value,
                          })
                        }
                        style={{ width: '100%' }}
                      />
                    ...
                    <div>
                      <label
                        htmlFor={`exam_date_${examNum}_even`}
                        style={{
                          display: 'block',
                          marginBottom: '0.25rem',
                          fontSize: '0.875rem',
            ...
            <div>
              ...
              >
                The base URL where your application is hosted (used in Slack links and
                notifications)
              </small>
            </div>
              ...
              {Array.from({ length: config.total_exams }, (_, i) => i + 1).map((examNum) => (
                <div key={examNum} style={{ marginBottom: '0.75rem' }}>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange('grade_form_urls', {
                        ...config.grade_form_urls,
                        [examNum]: e.target.value,
                      })
                    }
            ...
            <div>
              ...
              >
                Section codes to ignore during Canvas roster import (comma-separated, e.g., "01" or
                "01,00"). Typically lecture sections that should not be assigned to students.
                Default: "01" (Stanford convention).
              </small>
              <div
                style={{
                  marginTop: '0.75rem',
              ...
              >
                ...
                <p style={{ margin: '0.5rem 0 0 0', color: '#1e40af' }}>
                  For "F25-PSYCH-10-01 and F25-STATS-60-01 and F25-STATS-60-05", setting this to
                  "01" will ignore both lecture sections (-01) and assign the student to section 05.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              >
                When enabled, students are distributed evenly across all TAs and odd/even weeks,
                regardless of their section assignment. This helps balance workload when sections
                have uneven enrollment numbers.
              </small>
              <div
                style={{
                  marginTop: '0.75rem',
              ...
              >
                ...
                <p style={{ margin: '0.5rem 0 0 0', color: '#92400e' }}>
                  When this is enabled, students will be scheduled with TAs from any section, not
                  just their assigned section. Section assignments are still maintained for grading
                  purposes, but scheduling is distributed across all available TAs.
                </p>
              </div>
            </div>
        ...
        {activeTab === 'integrations' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            >
              <h5 style={{ margin: '0 0 0.75rem 0', color: '#1976d2' }}>
              ...
              <ol style={{ margin: 0, paddingLeft: '1.25rem', lineHeight: '1.6' }}>
                ...
                <li style={{ marginBottom: '0.5rem' }}>
                  Go to <strong>Settings → Public Access</strong> and enable{' '}
                  <strong>Allow Public Access</strong>
                </li>
                <li style={{ marginBottom: '0.5rem' }}>
            ...
            <div>
              <label
                htmlFor="cloudflare_r2_account_id"
                style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '600' }}
              >
            ...
            <div>
              <label
                htmlFor="cloudflare_r2_access_key_id"
                style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '600' }}
              >
                R2 Access Key ID
              </label>
            ...
            <div>
              <label
                htmlFor="cloudflare_r2_secret_access_key"
                style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '600' }}
              >
            ...
            <div>
              <label
                htmlFor="cloudflare_r2_bucket_name"
                style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '600' }}
              >
                R2 Bucket Name
              </label>
            ...
            <div>
              <label
                htmlFor="cloudflare_r2_public_url"
                style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '600' }}
              >
                R2 Public URL
              </label>
            ...
            <hr
              style={{ border: 'none', borderTop: '1px solid var(--border)', margin: '1.5rem 0' }}
            />
        ...
        {activeTab === 'slack-messages' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            >
              ...
              {config.slack_test_mode && (
                <div>
                  ...
                  >
                    <strong>⚠️ Warning:</strong> When test mode is enabled, ALL Slack messages will
                    be sent only to this user ID instead of the actual recipients. Use this for
                    testing before sending to students/TAs.
                  </small>
                </div>
              )}
            ...
            >
              ...
              >
                <li>
                  <code>{'{{student_name}}'}</code> - Student's full name
                </li>
                <li>
                  <code>{'{{exam_number}}'}</code> - Exam number (1-5)
                </li>
                <li>
                  <code>{'{{ta_name}}'}</code> - TA's full name (for TA messages)
                </li>
                <li>
                  <code>{'{{date}}'}</code> - Exam date (e.g., Friday, October 10, 2025)
                </li>
                <li>
                  <code>{'{{time}}'}</code> - Exam time slot (e.g., 1:30 PM - 1:37 PM)
                </li>
                <li>
                  <code>{'{{location}}'}</code> - Exam location/room
                </li>
                <li>
                ...
                <li>
                  <code>{'{{term}}'}</code> - Term (e.g., Fall 2025)
                </li>
                <li>
                  <code>{'{{facilitator}}'}</code> - TA/facilitator name
                </li>
                <li>
                  <code>{'{{ta_page_url}}'}</code> - URL to TA page
                </li>
                <li>
                  <code>{'{{grade_form_url}}'}</code> - URL to grade form
                </li>
                <li>
                  <code>{'{{student_count}}'}</code> - Number of students (for TA messages)
                </li>
              </ul>
            </div>
            ...
            <div>
              <h4 style={{ color: 'var(--primary)', marginTop: 0, marginBottom: '1rem' }}>
                Template Variables
              </h4>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                <div>
                  <label
                    htmlFor="slack_exam_location"
                    style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '600' }}
                  >
                    Exam Location{' '}
                    <code style={{ fontWeight: 'normal', color: 'var(--text-light)' }}>
                      {'{{location}}'}
                    </code>
                  </label>
                  <input
            ...
            <div>
              ...
              <textarea
                ...
                placeholder={
                  '📝 TEST: Oral Exam Session for {{student_name}}\n\nDate: {{date}}\nTime: {{time}}\nLocation: {{location}}\nFacilitator: {{ta_name}}\n\n📋 Course: {{course}} | 🎓 Term: {{term}}'
                }
                rows="10"
            ...
            <div>
              ...
              >
                Message template sent to TAs/admins with full schedule. Use{' '}
                <code
                  style={{
                    background: 'var(--background)',
